...
<head>
  ...
  <title>Proyecto BenchMark</title>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          <li class="nav-item">
            ...
            <a class="nav-link js-scroll-trigger" href="#portfolio">Hardware</a>
          </li>
          <li class="nav-item">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">HardWare</h2>
          <h3 class="section-subheading text-muted">En esta seccion puede eligir el tipo de producto que desea realizar comparaciones.</h3>
        </div>
      </div>
      <div class="row justify-content-center">
...
<section id="360">
    ...
    <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">CONOZCA NUESTRAS OFICINAS</h2>
          <h3 class="section-subheading text-muted"></h3>
        </div>
    </div>
      <div class="row">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h3><b class="contact">Teléfono: +59921236388</b></h3>
        </div>
        </div>
      </div>
    </div>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <span class="copyright">Copyright &copy; BenchMark 2019</span>
        </div>
        <div class="col-md-4">
          <ul class="list-inline social-buttons">
            <li class="list-inline-item">
          ...
          <div class="row">
            <div class="col-lg-4 mx-auto">
              <div class="modal-body">
                ...
                <h2 class="text-uppercase">Tarjetas Gráficas</h2>
                <p class="item-intro text-muted">Una tarjeta gráfica es una tarjeta de expansión de la placa base 
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <!-- Project Details Go Here -->
                <h2 class="text-uppercase">Procesadores</h2>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <!-- Project Details Go Here -->
                <h2 class="text-uppercase">Case</h2>
                <p class="item-intro text-muted"></p>
                <img class="img-fluid d-block mx-auto" src="img/portfolio/06-full.jpg" alt="">
                <p></p>
                <ul class="list-inline">
                <li > <a href="https://www.google.com/">Conoce Más</li>
                </ul>
